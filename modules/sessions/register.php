...
<html>
  ...
  <body class="hold-transition register-page">
    ...
    <span class="glyphicon glyphicon-briefcase"></span>
           	 ...
           	 <select name="membre" class="form-control" required  data-error="Veuillez choisir votre type d'inscription">
                <option value="" selected disabled="disabled">Vous êtes</option>
                <option value="2">Assistant de Prévention</option>
                <option value="3">Agent DRH</option>
            </select>            
    ...
    <span class="glyphicon glyphicon-briefcase"></span>
            ...
            <input type="text" class="form-control" placeholder="Votre Service" required name="service" data-error="Veuillez le nom de votre service">
