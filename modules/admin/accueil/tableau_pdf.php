...
/***** Mise en page 23/08/2016, Cédric ****/
...
switch ($afficheFiche['quest0_typecontrat']) {
  ...
  case 3: $contrat="Saisonnier";
    ...
    case 6: $contrat="Apprenti";
        break;
    case 7: $contrat="Recrutement direct (aux, stagiaire, fonctionnaire)";
        break;
...
-moz-border-radius: 0px 20px 0px 10px;
-webkit-border-radius: 0px 20px 0px 10px;
}	
...
color:#006997;
  ...
  <body class="hold-transition skin-blue sidebar-mini">
  	...
  	<div align="center"><img src="../../../include/img/logo_300.png" width="60" height="61"><h2>Fiche "Accueil nouvel agent"</h2></div>
...
<li><div class="cellule1"><b>Date de naissance : </b></div><div class="cellule2g">  <?php echo htmlspecialchars($afficheFiche['quest0_matricule']); ?></div></li>
...
<li><div class="celulle1"><b>Droit de retrait : </b></div><div class="cellule2">  <?php questRadioPdf($afficheFiche['quest8_retrait'],htmlspecialchars($afficheFiche['quest8_retrait_personne']),$afficheFiche['quest8_retrait_delai']); ?></li>
 ...
 <br> <br> <br>
 &nbsp; &nbsp; &nbsp; Fait le :  <br> <br><br>
 &nbsp; &nbsp; &nbsp; <div class="agent">L'assistant de prévention<br><?php echo $infoAdp['nom_membre']." ".$infoAdp['prenom_membre']; ?><br><br><br><br>Signature<br> </div> 
<div class="adp">L'agent<br><?php echo htmlspecialchars($afficheFiche['quest0_nom']); ?><br><br><br><br>Signature<br></div>    
