...
//verification des zones autorisés pour l'administrateur
$verif_zone1=$administrateurs->verif_zone(1,$id_membre);
$verif_zone2=$administrateurs->verif_zone(2,$id_membre);


if ($verif_zone1 == TRUE){echo " onclick=\"location.href='change_zone.php?zone=1&id_membre=$id_membre&etat=off';\" checked ";}else{echo " onclick=\"location.href='change_zone.php?zone=1&id_membre=$id_membre&etat=on';\"";}
echo "> Accueil  &nbsp; &nbsp; &nbsp;&nbsp; 
<input type=\"checkbox\""; 
if ($verif_zone2 == TRUE){echo " onclick=\"location.href='change_zone.php?zone=2&id_membre=$id_membre&etat=off';\" checked";}else{echo " onclick=\"location.href='change_zone.php?zone=2&id_membre=$id_membre&etat=on';\"";}
		 
echo "> Accident de service &nbsp; &nbsp; &nbsp;&nbsp; </td> ";
