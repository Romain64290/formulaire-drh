...
<html>
  ...
  <body class="hold-transition login-page">
	...
	<img src="../include/img/logo_300.png" class="img-responsive" style="display: block; margin-left: auto; margin-right: auto;margin-bottom: 20px">
        ...
        <a href="../modules/sessions/register.php" class="text-center">Créez votre compte</a><br>
        </p>
	<p class="text-danger"><?php if($erreur==1){echo"Nom d'utilisateur ou mot de passe incorrect !";} ?></p>
	
      </div><!-- /.login-box-body -->
      
   <div align="center"> <br><br><small>Réalisation : Service Développements et Innovations Numériques - 2016</small></div>
